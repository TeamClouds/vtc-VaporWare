...
uint8_t decorations[] = {
    ...
    DRAWLINE, ATTRGROUP, ATTRALIGN, ABSOLUTE, ENDATTRGROUP, 1,0,1,89, /* Left boarder */
    DRAWLINE, ATTRGROUP, ATTRALIGN, ABSOLUTE, ENDATTRGROUP, 42,0,42,89, /* Right boarder */
    DRAWLINE, ATTRGROUP, ATTRALIGN, ABSOLUTE, ENDATTRGROUP, 1,89,42,89, /* bottom boarder */
...
/*
    ...
    */
    VAPTRISFIELD, ATTRGROUP, ATTRLOCATION, 4, 0, ENDATTRGROUP,
    VAPTRISSCORE, ATTRGROUP, ATTRLOCATION, 4, 90, ENDATTRGROUP,
    VAPTRISLEVEL, ATTRGROUP, ATTRLOCATION, 4, 100, ENDATTRGROUP,
